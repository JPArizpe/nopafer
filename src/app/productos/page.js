    ...
    <>
      ...
      <div className='container maxWidth'>
        <div className={style.inicio}>
          ...
          <p>Manual: ENRIQUECIMIENTO PROTEICO DEL NOPAL (OPUNTIA SPP) COMO FORRAJE EN EL NORTE DE MÉXICO. URUZA- UACh, 2015. (<a>Ver</a>)</p>
          <div className={style.divider}></div>
          <p>Folleto: VARIEDADES DE NOPAL SIN ESPINA, VERDURA - FORRAJE: CHAPINGO, NARRO Y ESCOBAR COMO MATERIA PRIMA PARA SU ENRIQUECIMIENTO PROTEICO EN LAS ZONAS ÁRIDAS DEL NORTE DEL PAÍS. URUZA- UACh, 2020. (<a>Ver</a>)</p>
          <div id="multimedia"></div>
          <div className={style.divider}></div>
          <p>Folleto: TRANSFERENCIA DE LA TECNOLOGÍA DE ENRIQUECIMIENTO PROTEICO DE NOPAL. Dirección de Centros Regionales Universitarios- UACh, 2020. (<a>Ver</a>)</p>
          <Title title='multimedia' />
          <p>ENRIQUECIMIENTO PROTEICO DEL NOPAL (OPUNTIA SPP) COMO FORRAJE EN EL NORTE DE MÉXICO. URUZA-UACh, 2015. (<a>Ver</a>)</p>
          <div className={style.divider}></div>
